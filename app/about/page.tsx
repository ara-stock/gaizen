...
export const metadata: Metadata = {
  title: '筆者について',
  description: '個人投資家ara。株式の長期投資を続けながら、現在はPerp DEXやDeFiなど仮想通貨プロダクトを実際に触り、その状況をトラッカーとして公開しています。',
  alternates: { canonical: 'https://gaizen.xyz/about/' },
}

const sections = [
  { title: 'いま取り組んでいること', body: '現在は仮想通貨のプロダクトを実際に触ることに時間を使っています。Perp DEX（Hyperliquid、Lighter、Extendedなど）での取引と、Solana上のDeFi（Jupiter、Meteoraなど）の利用が中心です。どのプロジェクトを触っていて、TGEやエアドロップがどの段階にあるのかを自分で見失わないために作ったのが、このサイトのトラッカーです。' },
  { title: 'トラッカーの方針', body: '調達額・チーム・TGE時期などの事実は、公式発表と主要メディアの報道で確認し、出典を載せます。確認できなかった項目は「未確認」と書き、推測で埋めません。受取見込みは公開情報からの機械的な試算で、将来の金額を約束するものではありません。紹介リンクのあるプロジェクトもないプロジェクトも、同じ基準で載せます。' },
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
      ...
      <div className="mt-10 flex flex-wrap gap-x-6 gap-y-2 text-sm text-accent">
        <Link className="inline-flex min-h-11 items-center underline underline-offset-4" href="/">プロジェクト トラッカー</Link>
