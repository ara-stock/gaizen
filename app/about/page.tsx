...
const sections = [
  { title: 'いま取り組んでいること', body: '現在は仮想通貨のプロダクトを実際に触ることに時間を使っています。Perp DEX（Hyperliquid、Lighter、Extendedなど）での取引と、Solana上のDeFi（Jupiter、Meteoraなど）の利用が中心です。どのプロジェクトを触っていて、TGEやエアドロップがどの段階にあるのかを自分で見失わないために作ったのが、このサイトの Airdrop のページです。' },
  ...
  { title: '株式投資について', body: '株式は、個別企業の事業の成長性と持続性を軸に、少なくとも5年以上を考えて保有しています。保有銘柄と資産配分は Portfolio のページで公開しています。私自身の条件に基づくもので、読者向けのモデルポートフォリオではありません。' },
]
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
      ...
      <div className="mt-10 flex flex-wrap gap-x-6 gap-y-2 text-sm text-accent">
        <Link className="inline-flex min-h-11 items-center underline underline-offset-4" href="/">Airdrop（参加状況）</Link>
        <Link className="inline-flex min-h-11 items-center underline underline-offset-4" href="/portfolio/">Portfolio（保有方針・資産配分）</Link>
