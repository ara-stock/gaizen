...
const sections = [
  ...
  {
    title: '投資助言ではありません',
    body: `本サイトに掲載されているすべての情報・分析・見解・データは、一般的な情報提供および教育目的のために作成されたものです。特定の金融商品・有価証券・暗号資産の売買を勧誘・推奨するものではなく、金融商品取引法に基づく投資助言・投資一任契約に該当するものでもありません。\n\n本サイトで言及される個別銘柄・ETF・インデックス・投資信託・暗号資産は、あくまで筆者個人の経験・考察に基づく情報提供であり、購入・保有・売却を推奨するものではありません。`,
  },
  {
    title: '自己責任の原則',
  ...
  {
    title: '情報の正確性・最新性',
    body: `本サイトに記載されている情報（数値・制度・商品スペック等）は、執筆時点のものです。税制・法令・各金融商品の仕様は変更されることがあり、掲載内容が現状と異なる場合があります。最新の情報は金融庁・各証券会社・発行体の公式情報をご確認ください。\n\n本サイトは定期的な情報更新を努めますが、すべての情報を常に最新の状態に保つことを保証するものではありません。`,
  },
  {
    title: '投資リスクについて',
  ...
  {
    title: 'リファラルリンク・海外サービスについて',
    body: `本サイトは、暗号資産取引所・DeFiサービスなどのリファラルプログラム（紹介報酬プログラム）に参加しており、「始める」ボタンなどの紹介リンク経由で登録・取引が行われた場合に報酬を受け取ることがあります。紹介リンクにはその旨を表示しています。\n\nこれらの収益は本サイトの運営費用に充てられます。リファラル収益の有無は、掲載内容の公平性・中立性に影響しないよう努めています。\n\nトラッカーに掲載している海外のDEX・サービスの多くは、日本の金融庁に暗号資産交換業者として登録されていません。利用できるかどうか、および税務上の取り扱いは、ご自身の責任で確認してください。エアドロップの受取見込みは公開情報に基づく機械的な試算であり、実際の配布の有無や金額を保証するものではありません。`,
  },
  {
    title: '外部リンクについて',
  ...
  {
    title: '著作権',
    body: `本サイトに掲載されているテキスト・画像・データ・デザイン等の著作権は、特段の記載がない限り運営者に帰属します。無断転載・複製・改変・商業利用を禁じます。引用する場合は出典（サイト名・ページURL）を明記してください。`,
  },
  {
    title: '免責事項の変更',
