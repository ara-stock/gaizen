...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://gaizen.xyz/contact/' },
}
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="space-y-4">
        {[
          ...
          { platform: '掲載内容の訂正依頼', handle: 'GitHub Issues', url: 'https://github.com/ara-stock/gaizen/issues/new?title=%E8%A8%82%E6%AD%A3%E4%BE%9D%E9%A0%BC', description: '該当URLと訂正が必要な箇所をお知らせください。確認後、必要に応じて内容を更新します。' },
        ].map(item => (
      ...
      <div className="mt-10 p-5 rounded-lg border" style={{ backgroundColor: 'var(--surface)', borderColor: 'var(--border)' }}>
        <p className="text-sm leading-relaxed" style={{ color: 'var(--muted)' }}>
          掲載内容の事実関係に誤りがある場合は、訂正依頼から該当URLと根拠資料をお知らせください。
