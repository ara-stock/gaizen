...
## The Question: "Is 100% Equities Enough?"
...
## Why I Keep Bonds Out of My Portfolio
...
## Why I Hold Gold — Finite Supply in the Ground

Gold pays no dividends or interest. It runs no business. I still hold around 3% because **its supply is physically constrained.**

Fiat currencies can be issued without limit by central banks. Equities too can be diluted through new share issuance. But the total amount of gold in the earth is finite, and annual mining output is limited to roughly 1–2% of global above-ground stock.

When inflation occurs, the real value of goods stays the same, but **the overall price level is pushed up.** Assets whose supply cannot be increased tend to appreciate in relative value at such times. This is the logic behind holding gold as an inflation hedge.

Gold also offers a psychological anchor during episodes of sharp price swings in either direction: because the reason for holding it is clear — scarcity — I am less likely to be rattled by day-to-day price movements.

---

## Why I Hold Crypto — Designed Scarcity

The same "scarcity" logic applies to crypto, but Bitcoin takes it further: **the total supply is hard-capped at 21 million coins by design.**
...
| S&P500 | 24% | eMAXIS Slim S&P500 (monthly contributions) |
| US equities | 9% | Individual stocks |
| Crypto | 5% | BTC, DeFi |
| Gold | 3% | 純金積立 (gold accumulation plan) |
| Cash | 2% | Standby funds / emergency reserve |

Equities account for a combined 90%, while gold and crypto together make up 8%. **Equities are the main engine; the scarcity assets are firmly in a sub-position.**
