...
- **Social / communication**: Instagram, X (formerly Twitter), Facebook
- **Shopping / cloud**: Amazon (including AWS)
...
A trade deficit in goods can improve if imports fall. The digital services deficit is different.

- **No substitutes**: Replacing the App Store with a Japan-made equivalent is not realistic
...
There are three theoretical ways to address the digital deficit. Each has significant trade-offs.

### 1. Developing Japanese Digital Services

The fundamental solution, but extraordinarily difficult in practice. Building a platform that can compete with App Store or YouTube would require decades and massive investment.
...
Japan has had discussions about taxing foreign digital services, but aggressive taxation risks pushing foreign companies to exit Japan or pass costs through to users. The EU has moved further on this, but Japan has not fully implemented it. Each approach involves real costs.

The realistic outcome is **incremental adjustments and continued management of the imbalance** — not a structural resolution.

## On "Fair Value" for the Yen
