...
## The Verdict: Growth Investing Is More Rational — but a Dividend-Growth Blend Works Too

When the goal is maximizing wealth, **growth investing (or a growth-oriented index) is the more rational choice.**

That said, long-term investing carries real psychological weight. For that reason, **a hybrid approach holding 30–50% in dividend-growth stocks is also a valid strategy.**

## What It Means When a Company Pays Dividends

A company paying dividends is returning profits to shareholders. That sounds appealing — but it also signals that **the business has fewer high-return opportunities to reinvest in.**

Mature, stable businesses distribute surplus profits as dividends because their growth runway is limited. Growing companies, by contrast, channel profits into new products, market expansion, and acquisitions — compounding returns internally.

**My view is that investing in companies with significant room to grow tends to produce higher long-term returns.**

## Compounding: Dividends Leak Taxes Every Time They're Paid

Every time a dividend is paid, taxes are triggered — roughly 20% in a standard Japanese brokerage account.

```
Dividend reinvestment cash flow

Company profits
 └─ Paid out as dividends
      └─ ~20% withheld as tax
           └─ Net proceeds reinvested
                └─ 20% lost from the compounding base each time
```

No-distribution index funds (eMAXIS Slim, etc.) reinvest internally without paying out. **Tax is deferred until you sell, so compounding runs uninterrupted.**

```
No-distribution index cash flow

Company profits (inside the fund)
 └─ Reinvested internally (no tax)
      └─ Full principal compounds
           └─ Taxed once, at sale
```

Over decades, this difference becomes significant.

## Tax Efficiency: NISA Makes Both Tax-Free — With One Catch
...
The key distinction here is not high dividends — it's **consistently growing dividends.**

### Criteria for Selecting Dividend-Growth Stocks

| Criteria | Target |
|---|---|
| Consecutive years of dividend growth | 10+ years is a strong signal |
| Payout ratio | 40–50% is healthy (too high risks a cut) |
| Business stability | Sectors with lower cyclicality are preferable |

A company with a payout ratio of 80–90% has little buffer — a modest earnings dip could force a dividend cut. Always check whether the dividend is sustainable.

### Sectors I Hold for Dividend Growth
...
[Satellite]
 Dividend-growth stocks (trading companies, leasing, banks, insurers)
 ───────────────────── 30–50%
```

For dividend-growth stocks, fractional shares (available at most Japanese brokerages) let you build positions gradually with small amounts — no need to buy full lots all at once.
