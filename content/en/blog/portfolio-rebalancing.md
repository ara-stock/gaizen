...
Rebalancing is the act of buying and selling assets to restore your portfolio's allocation back to its original target, after market movements have caused it to drift.

Say you started with an 80% stocks / 20% bonds allocation. If stocks rise sharply, your portfolio naturally shifts to something like 85% stocks / 15% bonds. Correcting that drift is what rebalancing means.

**There are two main reasons rebalancing is considered necessary.**
...
There are two schools of thought on when to rebalance.
...
## The Tax Cost Trade-Off

The biggest pitfall of rebalancing is **tax cost**.

When you sell assets held in a 特定口座 (taxable brokerage account), any capital gains are subject to a tax of approximately **20.315%**. Selling an appreciated asset to rebalance locks in that gain for taxation on the spot.
...
## NISA and Rebalancing: A Complicated Relationship
...
Rebalancing within NISA should be reserved for situations where the allocation has drifted severely and cannot be corrected through future contributions alone.
...
1. Check your current allocation and measure the drift from your target
2. Increase contributions or purchases toward the underweight asset class
3. Avoid selling (except when drift is very large)

For example, if Japanese stocks have grown above their target weight, focus your next purchase on S&P 500 or another asset. That is all it takes.

As your total assets grow and buying alone can no longer close the gap, partial selling in a taxable account becomes a valid option. Even then, it makes sense to set a rule and act only when the drift is significant — a reasonable threshold is more than 10 percentage points from your target.
