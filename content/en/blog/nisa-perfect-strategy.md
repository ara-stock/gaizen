...
```
Return distribution across 100 market participants (conceptual)

Top 10%     ██                    Significantly outperform
Top 30%     ████████              Slightly above market average
            ────────────────────  Market average (what the index captures)
...
Once you've secured the ¥100K/month for the accumulation allowance, put any remaining surplus into the growth allowance (up to ¥2.4M/year).

### Why Lump-Sum?

As I've written elsewhere, **no one can reliably predict when markets will rise or fall.**

- "It's expensive right now, I'll wait" → Markets can keep climbing
- "It'll drop further" → It might reverse immediately

The rational move is to invest whenever you have the capital. In years when I have sufficient surplus, I lump-sum the growth allowance at the start of the year.

### You Can Still Just Buy Index Funds in the Growth Allowance
...
Income
 └─ After living expenses and fixed costs
      ├─ Accumulation allowance: ¥100K/month (S&P500 or All-Country) ← top priority, automated
      └─ Remaining surplus
           └─ Growth allowance: invest whenever surplus is available
                               (lump-sum in January in strong income years)
```

## Common Questions

**Q. Is there a difference between eMAXIS Slim and the Rakuten/SBI versions?**

Expense ratios are nearly identical. Just use whichever fund is available in your brokerage. I use eMAXIS Slim personally, but the outcome won't differ materially.

**Q. Should I buy different funds in each allowance?**

Not necessarily. Buying S&P500 in both is perfectly fine. If you want slight diversification, All-Country in one and S&P500 in the other is also a reasonable split.

**Q. Is it worth using the growth allowance for individual stocks?**

Yes — but only if you have genuine conviction. The tax-free cap is finite, so reserving it for your highest-conviction ideas makes sense. Don't use it speculatively.
