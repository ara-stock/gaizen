...
費用の影響だけを見るため、年率コスト0.1%と1.6%の架空の商品を比較します。実在商品の手数料や将来リターンを示すものではありません。投資対象や戦略が異なる実在ファンド同士を、コストだけで優劣判定することもできません。

この差が複利で積み重なると、長期では資産残高に大きな開きが生まれます。

**元本1,000万円、費用前の年率リターン7%、10年間、分配は全額再投資と仮定**
...
`1,000万円 × (1 + 7% - 年率コスト)^10` という簡略計算で、差は約257万円です。実際の費用は日々の残高などに応じて発生し、税金や購入時手数料も結果を変えます。購入前に最新の目論見書と販売会社の手数料を確認します。

## 問題②：分配金は「利益の受け取り」ではない

**分配金の一部または全部が「元本払戻金（特別分配金）」になる場合があります。** 必ずそうなるわけではありません。国内の公募株式投信では、投資家ごとの個別元本と分配落ち後の基準価額により区分されます。同じファンドの同じ分配でも、購入した人によって内訳が異なる場合があります。
...
**分配率とリターンは別の数字です。** [QYLDの公式説明](https://www.globalxetfs.com/funds/qyld/)も、分配率はトータルリターンを示さず、分配に元本払戻し相当を含む可能性があると注意しています。米国ETFの税務上の区分と、日本の投信の特別分配金は同じ制度ではありません。

単純な架空例では、100万円で買った資産が1年後90万円になり、その間の分配金が10万円なら、税金・再投資・費用を無視した損益は `90万円 + 10万円 - 100万円 = 0円` です。「10万円受け取れたから10%儲かった」とは言えません。
...
長期投資の基本となる商品選びについては[投資信託の目論見書・月報の読み方](/blog/how-to-read-mutual-fund-documents/)、取り崩し期の設計については[積立投資の「出口戦略」](/blog/investment-exit-strategy/)をご覧ください。
