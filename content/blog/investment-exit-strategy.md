...
FIRE計画でよく使われる「4%ルール」は、**初年度に開始時資産の4%を取り崩し、その後はその金額を物価に合わせて調整する**考え方です。「毎年、その時点の残高の4%を売る」定率売却とは異なります。ベンゲンの1994年の研究や、その後のトリニティ・スタディなど、米国の過去の株式・債券データによる検証が背景にあります。将来の安全な取り崩し率を保証するものではありません。

例えば開始時の資産が7,500万円なら、初年度は300万円。翌年の物価上昇を2%と仮定すると、2年目は306万円です。下落後の残高に4%を掛け直す計算ではないため、退職直後の下落と取り崩しの重なりには注意が必要です。7,500万円あれば誰でも安心という意味ではなく、次の前提を確認します。
...
| 証券会社 | サービス名 | 特徴 |
|---|---|---|
| 楽天証券 | 定期売却サービス | 対象商品・口座、売却方式、受取日を公式案内で確認 |
| SBI証券 | 定期売却サービス | 対象商品・口座、売却方式、受取日を公式案内で確認 |
