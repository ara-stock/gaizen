...
私が使っている管理方法をもとに、個人情報と実際の資産額を含まないExcelテンプレートを作成しました。

- 銀行、証券会社、iDeCo、確定拠出年金、ポイント、商品券、現金、暗号資産を記録
- カテゴリ小計、総資産、前月比、年初比を自動計算
- 総資産とカテゴリ別残高を棒グラフで表示
- 入力するセルを黄色で表示
- Googleスプレッドシートへの取り込みに対応

[月次資産記録テンプレート（Excel）をダウンロード](/downloads/gaizen-asset-tracking-template.xlsx)

ファイルの作成者情報はGAIZEN FINANCEとしており、私個人のGoogleアカウントやメールアドレスは含まれていません。ダウンロード後にGoogleドライブへアップロードし、ご自身のスプレッドシートとして利用できます。

グラフに表示される増減には、運用損益だけでなく給与・賞与からの入金や生活費の支出も含まれます。正確な運用利回りではなく、資産全体の推移を確認するための表として使ってください。
