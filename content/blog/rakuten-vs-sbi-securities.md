...
## 結論：操作性で楽天、使いたい機能があればSBIも比較

すでにSBI証券などで必要な投信を積み立てられているなら、乗り換えや口座追加は必須ではありません。以下は私の使い分けであって、全員に二つの口座や有料カードが必要という結論ではありません。
...
私には楽天証券の操作画面が使いやすいと感じられます。ただし、[iSPEED](https://ispeed.jp/smartphone/)の株式取引画面と、投資信託の積立設定画面は別です。iSPEEDだけでNISAの投信積立が完結するという意味ではありません。証券会社サイトの投信積立画面で、商品名・口座区分・引落方法を確認します。
...
IPOを検討する際の候補にはなりますが、取扱銘柄や抽選条件を確認して選びます。当選や利益を保証するものではありません。

### Vポイントが貯まる

投信保有残高に応じたポイントと、クレジットカードで積み立てた金額に応じたポイントは別の制度です。カードの種類や年間利用額の条件が関係するのはクレカ積立の還元で、ゴールドカードを持てば保有残高への還元率も上がるとは限りません。年会費や不要な支出を増やしてまでポイントを追わないようにします。
...
| 項目 | 楽天証券 | SBI証券 |
|---|---|---|
| 国内株売買手数料 | ゼロコースの適用条件を確認 | ゼロ革命の適用条件を確認 |
...
| 米国株円貨決済 | 可 | 可 |
| 債券ラインナップ | 希望通貨・満期・発行体を個別確認 | 希望通貨・満期・発行体を個別確認 |
