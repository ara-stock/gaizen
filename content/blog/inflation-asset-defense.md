...
具体的には[S&P500](/blog/sp500-index-investing/)や[オルカン](/blog/why-sp500-over-allcountry/)のインデックスファンドを軸に据えることが合理的です。コモディティを扱う企業（資源・エネルギー・素材セクター）の利益もインデックスに含まれるため、コモディティ価格の上昇も間接的に享受できます。
