...
| 仮説を見直す条件 | 広告・クラウドの利益や利益率の伸び悩み、赤字化 |

※上表は筆者個人の判断基準であり、将来のリターンを保証するものではありません。

本記事は筆者への聞き取りに基づく投資理由と、一次資料による補足を分けて整理したものです。売買日や約定価格を記録した取引日誌ではありません。調査順序と、今後使える記録用ひな形は[個別株の投資仮説の作り方](/blog/individual-stock-investment-thesis/)にまとめています。
...
5. 追加後の構成比も確認する（読者向けの確認案。筆者は固定の保有上限を設けていません）
...
ここからは、その判断を点検するための補足です。以下は聞き取りで確認した実際の売却ルールではなく、一時的な費用と事業の変化を区別するための確認案です。
...
本記事は特定銘柄の購入を推奨するものではありません。個別株には元本割れの可能性があります。筆者の投資理由と補足の確認案は、実際の売買実績や運用成績を示すものではありません。
