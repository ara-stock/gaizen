...
:::comment
私が投資信託を選ぶとき、最初に見るのは構成銘柄・純資産総額・手数料です。

基本的にはS&P500かオルカンしか保有していません。新しい商品を次々探すというより、S&P500と比べて、追加で持つ理由があるかを確認します。優れているように見える商品でも、実際のトータルリターンやコストを見ると、S&P500を選べばよいと感じるケースが多いです。
:::
...
:::comment
私はかなり保守的に、基本的には純資産総額5,000億円以上の投資信託を選ぶようにしています。

500億円以下だから直ちに危険という意味ではありません。ただ、長期間積み立てる中核商品には、規模が大きく、資金が集まり続けている商品を選びたいと考えています。
:::
...
:::comment
私が許容する信託報酬は、基本的に年率0.1〜0.2%程度です。この範囲を超える場合は、コストに見合う投資対象や運用結果があるかを慎重に確認します。

コストが高い商品は、それだけで将来の利回りを押し下げます。同じ指数への連動を目指す商品なら、低コストの商品を優先します。
:::
...
:::comment
投資信託は、商品数が多いほど正解を探したくなります。しかし、私はS&P500かオルカンを軸にし、それ以外の商品には「追加で持つ明確な理由」を求めています。

特に実質コストは必ず見てください。目立つ信託報酬が低くても、実際の運用費用を含めると差が出る場合があります。投資信託は長く持つ商品だからこそ、購入前の数分の確認が長期で効いてきます。
:::
