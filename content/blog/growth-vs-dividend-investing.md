...
インデックス投資と増配株を併用するなら、次のような配分は考え方を整理する一例になります。私の現在の資産配分を示すものではありません。
...
- 分配を抑える商品は、運用中の課税や再投資の手間を減らしやすい
- 配当株は「事業が成熟しており、再投資先がない企業が還元する仕組み」
- 増配株の比率は、配当の安心感だけでなく事業内容と集中リスクから決める
- 高配当より「継続的に増配していること」と「配当性向40〜50%」を基準にする
- 個別株は高配当だけで選ばず、利益成長と配当の持続性を確認する

:::comment
成長投資と配当投資は対立するものではありません。現在は事業の成長性と持続性を先に見て、その結果として配当が受け取れる銘柄も保有しています。配当が下落時の心理的な支えになることはありますが、それだけを理由に事業の停滞や減配リスクを見落とさないようにしています。
:::
